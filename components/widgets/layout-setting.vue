    ...
    <div id="setting_box" class="setting-box" :class="{ opensetting:layoutsidebar }">
      ...
      <div class="setting_box_body">
        ...
        <div class="setting-body">
          ...
          <div class="buy_btn">
            <a
              href="https://themeforest.net/item/mykids-responsive-ecommerce-html-template/22809967?s_rank=1"
              target="_blank"
              class="btn btn-block purchase_btn"
            >
              <i class="fa fa-shopping-cart" aria-hidden="true"></i> purchase mykids now!
            </a>
            <a
              href="https://themeforest.net/item/mykids-responsive-angular-ecommerce-template/22905358?s_rank=3"
              target="_blank"
              class="btn btn-block purchase_btn"
            >
              <img src="../../assets/images/icon/angular.png" alt class="img-fluid" /> mykids Angular
            </a>
            <a
              href="https://themeforest.net/item/mykids-responsive-react-ecommerce-template/23067773?s_rank=2"
              target="_blank"
              class="btn btn-block purchase_btn"
            >
              <img src="../../assets/images/icon/react.png" alt class="img-fluid" /> mykids React
            </a>
            <a
              href="https://themeforest.net/item/mykids-multipurpose-shopify-sections-theme/23093831?s_rank=1"
              target="_blank"
              class="btn btn-block purchase_btn"
            >
              <img src="../../assets/images/icon/shopify.png" alt class="img-fluid" /> mykids Shopify
            </a>
          </div>
        </div>
      </div>
